...
def main(cfg: DictConfig):
    ...
    # Determine paths
    footprint_path = "/media/irina/My Book/Petronas/DATA/vector_data/PipelineFootprint/PipelinesOfInterest_FS_50m_segments.gpkg"
    ...
    output_path = "/media/irina/My Book/Petronas/DATA/vector_data/PipelineFootprint/PipelinesOfInterest_FS_subplots.gpkg"
    ...
    try:
        ...
        smooth_centerline_gdf = read_vector_file(centerline_path)
