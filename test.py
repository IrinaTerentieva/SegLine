...
def main(cfg: DictConfig):
    ...
    if cfg.smoothening.get("perform_smoothing", False):
        steps = [
            "src/fixed_spacing/assign_ID.py",
            "src/fixed_spacing/smooth_centerline.py",
            "src/fixed_spacing/split_to_plots.py",
            "src/fixed_spacing/split_to_sides.py",
            "src/fixed_spacing/split_to_subplots.py"
        ]
    else:
        steps = [
            "src/fixed_spacing/assign_ID_spacing.py",
            "src/fixed_spacing/split_to_plots_spacing.py",
            "src/fixed_spacing/split_to_sides_spacing.py",
            "src/fixed_spacing/split_to_subplots_spacing.py"
        ]
